        ...
        <>
            <div className='lg:my-2 p-4'>
                <div className='flex justify-between mb-3'>
                    ...
                    <button  onClick={() => handleNavigate('thriller')}  className='text-white inline'>See all <AiOutlineArrowRight className='inline text-red-500'></AiOutlineArrowRight></button >
                </div>
